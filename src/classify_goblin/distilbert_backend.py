...
class LocalDistilBertRuntime:
    ...
    def __init__(self, model_path=None, device=None):
        path_value = model_path or get_env("CLASSIFY_GOBLIN_DISTILBERT_MODEL_PATH")
        schema.require(path_value, "CLASSIFY_GOBLIN_DISTILBERT_MODEL_PATH must identify a local checkpoint")
        ...
        self.model, self.tokenizer, self.config = load_checkpoint(
            path, device=device or get_env("CLASSIFY_GOBLIN_DISTILBERT_DEVICE"), local_files_only=True
        )
