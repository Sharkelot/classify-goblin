"""Profile assessor CLI (JEV-MM-11).
...
# Support both `python -m jev_laya_free.profile_assessor.cli` and
# `python src/jev_laya_free/profile_assessor/cli.py`.
try:
    ...
    from jev_laya_free.profile_assessor.roster import (
        RosterSnapshot, parse_profiles_root)
    from jev_laya_free.profile_assessor import assess
