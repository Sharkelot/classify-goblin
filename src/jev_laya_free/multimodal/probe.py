...
modality is ``verified`` only when the local probe (JEV-MM-01) exercised it
...
# SHA256 of the JEV-MM-01 runtime probe report (local observation evidence).
PROBE_REPORT_SHA256 = '31ed208a11d720d7aa06f0c87b74923318ed4f4cc41f4ac9a3cb6005e7997e3e'

# Local observations from the JEV-MM-01 probe (not upstream claims).
_LOCAL_OBSERVATIONS = {
    'text': 'verified',
    'image': 'verified',
    'video': 'verified',
